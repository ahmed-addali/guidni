  ...
  return (
    <div className="max-w-screen-md mx-auto px-4 py-12">
      ...
      <div className="bg-white border border-gray-100 rounded-2xl p-6 text-center">
        <p className="font-semibold text-gray-900 mb-1">{t("contact.title")}</p>
        <p className="text-sm text-gray-500 mb-4">{t("contact.body")}</p>
        <Link
          href={`/${locale}/contact`}
        ...
        >
          {t("contact.button")} <ArrowRight className="h-4 w-4" />
        </Link>
      </div>

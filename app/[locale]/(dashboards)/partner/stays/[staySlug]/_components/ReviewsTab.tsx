...
function GuidniReviewSection({
  ...
  const t = useTranslations("PartnerDashboard.editStay.reviews");
...
export function ReviewsTab({ reviews, guidniReview, stayId }: Props) {
  const t = useTranslations("PartnerDashboard.editStay.reviews");
  ...
  return (
    <div className="space-y-6">
      <GuidniReviewSection guidniReview={guidniReview} stayId={stayId} />

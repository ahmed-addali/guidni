...
function GuidniReviewSection({
  ...
  const t       = useTranslations("PartnerDashboard.editRestaurant.reviews");
      ...
      <div className="flex items-start justify-between gap-4 flex-wrap">
        ...
        <div className="flex items-center gap-2 flex-wrap">
          ...
          <RequestReviewDialog
            ...
            offerHint={tDialog("restaurantOfferHint")}
          />
        </div>
      </div>
...
export function ReviewsTab({ reviews, guidniReview, restaurantId }: Props) {
  const t = useTranslations("PartnerDashboard.editRestaurant.reviews");
  ...
  return (
    <div className="space-y-6">
      <GuidniReviewSection guidniReview={guidniReview} restaurantId={restaurantId} />

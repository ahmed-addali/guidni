...
function GuidniReviewSection({ guidniReview, rentalId }: { guidniReview: GuidniReview; rentalId: string }) {
  const t       = useTranslations("PartnerDashboard.editRental.reviews");
      ...
      <div className="flex items-start justify-between gap-4 flex-wrap">
        ...
        <div className="flex items-center gap-2 flex-wrap">
          ...
          <RequestReviewDialog
            listingId={rentalId}
            relationType="RENTAL"
            offerHint={tDialog("rentalOfferHint" as Parameters<typeof tDialog>[0])}
          />
        </div>
      </div>
...
export function ReviewsTab({ reviews, guidniReview, rentalId }: Props) {
  const t          = useTranslations("PartnerDashboard.editRental.reviews");
  ...
  return (
    <div className="space-y-4">
      <div className="bg-white border border-gray-100 rounded-2xl p-6">
        <GuidniReviewSection guidniReview={guidniReview} rentalId={rentalId} />
      </div>

...
import { toggleProductFeatured } from "@/lib/actions/admin-shops";
...
export function ProductFeaturedToggle({ productId, featured }: Props) {
  ...
  function handleToggle() {
    ...
    setIsFeatured(next);
    start(async () => {
      const res = await toggleProductFeatured(productId, next);

...
import { FaCartShopping, FaMapLocationDot, FaTicket, FaCompass } from "react-icons/fa6";
...
export function CategoriesNav() {
  ...
  return (
    <>
      ...
      <div className="hidden sm:block bg-white border-b border-gray-100 shadow-sm">
        <MaxWidthWrapper>
